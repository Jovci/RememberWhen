    ...
    >
      <div className="flex flex-col gap-6 items-center">
        ...
        <div style={{ width: '100%', height: '400px' }}>
          <iframe 
            width='100%' 
            height='100%' 
            src="https://api.mapbox.com/styles/v1/jovci/clxbm0ukj024301pohxdx4u98.html?title=false&access_token=pk.eyJ1Ijoiam92Y2kiLCJhIjoiY2x2dWVzNzU2MWphdDJ3bzZ0NDh6dmR5ZiJ9.T8BAscTbUkJhCBTnq1_iSQ&zoomwheel=true#4/37.0902/-95.7129" 
            title="Untitled" 
            style={{ border: 'none' }}
          ></iframe>
        </div>
      ...
      <div className="flex flex-col md:pt-1 md:gap-11 gap-1 items-center">
        ...
        <div className="flex flex-col gap-6 max-w-2xl items-center">
          <Typography className="max-w-2xl" variant="h1">
            Invite Family and Friends Collab Now
          </Typography>
